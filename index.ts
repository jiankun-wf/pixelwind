...
class ImageResolver {
    ...
    private resolveWithUrl(url: string): Promise<Mat> {
        return new Promise((resolve, reject) => {
            ...
            img.addEventListener('load', () => {
                ...
                const imageData: ImageData = ctx!.getImageData(0, 0, cavans.width, cavans.height);
    ...
    gray(mat: Mat, color: string = '#000000') {
...
class Mat {
    ...
    recycle(callback: (pixel: Pixel, row: number, col: number) => void | 'break') {
